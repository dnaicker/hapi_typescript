...
// request: auth_token (String), credential_id (String)
// response: message to say complete
function createSelectiveCredentialProof(request, responseToolkit) {
    return __awaiter(this, void 0, void 0, function* () {
        trinsic.options.authToken = request.payload.auth_token;
        console.log(request.payload.auth_token);
        console.log(request.payload.credential_id);
        console.log(request.payload.reveal_template);
        const proofResponse = yield trinsic.credential().createProof(trinsic_1.CreateProofRequest.fromPartial({
            itemId: request.payload.credential_id,
            revealTemplate: {
                templateAttributes: request.payload.reveal_template,
            }
        }));
        console.log(proofResponse);
        const response = responseToolkit.response(proofResponse);
...
// request: auth_token (String), credential_id (String)
// response: message to say complete
function createCredentialSelectiveProofAndVerify(request, responseToolkit) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log(request.payload.auth_token);
            console.log(request.payload.credential_id);
            console.log(request.payload.credential_fields);
            // typescript loop through array
            const selectedFields = JSON.parse(request.payload.credential_fields);
            ...
            let verifyResponse = yield trinsic.credential().verifyProof({
...
function searchTemplate(request, responseToolkit) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log(request.payload);
        trinsic.options.authToken = request.payload.auth_token;
        const searchResponse = yield trinsic
            .template()
            .search(trinsic_1.SearchCredentialTemplatesRequest.fromPartial({
...
function getCredentialTemplate(request, responseToolkit) {
    return __awaiter(this, void 0, void 0, function* () {
        trinsic.options.authToken = request.payload.auth_token;
        const getTemplateData = yield trinsic
            .template()
            .get(trinsic_1.GetCredentialTemplateRequest.fromPartial({
...
function searchWallet(request, responseToolkit) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield trinsic
            .wallet()
            .searchWallet(trinsic_1.SearchRequest.fromPartial({
            query: request.payload.query,
            continuationToken: (_d = (_c = request.payload) === null || _c === void 0 ? void 0 : _c.continuation_token) !== null && _d !== void 0 ? _d : "",
        }));
        console.log(result);
...
// response: JSON-LD
function getJSONLD(request, responseToolkit) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(credential_id);
        const credential_json_ld = yield trinsic
            .wallet()
            .searchWallet(trinsic_1.SearchRequest.fromPartial({
        ...
        const credential_proof = yield trinsic.credential().createProof(trinsic_1.CreateProofRequest.fromPartial({
            documentJson: JSON.stringify((credential_json_ld === null || credential_json_ld === void 0 ? void 0 : credential_json_ld.items) ? [0] : ""),
        }));
...
function checkRevocationStatus(request, responseToolkit) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(request.payload.credential_status_id);
        trinsic.options.authToken = request.payload.auth_token;
...
// request: 
// response: 
function qrCodeShareCredential(request, responseToolkit) {
    return __awaiter(this, void 0, void 0, function* () {
        const trinsic = new trinsic_1.TrinsicService();
        // retrieve email
