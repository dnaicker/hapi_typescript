...
export declare type FromGrpcWebServiceDefinition<Service extends grpc.ServiceDefinition> = {
    [M in GrpcWebServiceMethodKeys<Service> as Uncapitalize<M>]: FromGrpcWebMethodDefinition<Service[M]>;
};
export declare type GrpcWebServiceMethodKeys<Service extends grpc.ServiceDefinition> = {
    [K in keyof Service]: Service[K] extends grpc.MethodDefinition<any, any> ? K : never;
}[keyof Service] & string;
export declare type FromGrpcWebMethodDefinition<Method> = Method extends grpc.MethodDefinition<infer Request, infer Response> ? MethodDefinition<Request, Request, Response, Response, Method['requestStream'], Method['responseStream']> : never;
