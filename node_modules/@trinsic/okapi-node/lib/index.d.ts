...
export declare class LdProofs {
    static createProof(request: proto.CreateProofRequest): Promise<proto.CreateProofResponse>;
}
export declare class Oberon {
    ...
    static verifyToken(request: proto.VerifyOberonTokenRequest): Promise<proto.VerifyOberonTokenResponse>;
}
...
export declare class OkapiMetadata {
    static getMetadata(): Promise<proto.MetadataResponse>;
}
