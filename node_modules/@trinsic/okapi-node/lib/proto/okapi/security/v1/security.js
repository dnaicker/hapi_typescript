...
exports.VerifyOberonTokenResponse = exports.VerifyOberonTokenRequest = exports.UnBlindOberonTokenResponse = exports.UnBlindOberonTokenRequest = exports.BlindOberonTokenResponse = exports.BlindOberonTokenRequest = exports.VerifyOberonProofResponse = exports.VerifyOberonProofRequest = exports.CreateOberonProofResponse = exports.CreateOberonProofRequest = exports.CreateOberonTokenResponse = exports.CreateOberonTokenRequest = exports.CreateOberonKeyResponse = exports.CreateOberonKeyRequest = void 0;
/* eslint-disable */
const minimal_1 = __importDefault(require("protobufjs/minimal"));
function createBaseCreateOberonKeyRequest() {
    return { seed: new Uint8Array() };
}
exports.CreateOberonKeyRequest = {
...
exports.CreateOberonKeyResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
...
exports.CreateOberonTokenRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.sk.length !== 0) {
...
exports.CreateOberonTokenResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
...
exports.CreateOberonProofRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.data.length !== 0) {
...
exports.CreateOberonProofResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
...
exports.VerifyOberonProofRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.proof.length !== 0) {
...
exports.VerifyOberonProofResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
...
exports.BlindOberonTokenRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.token.length !== 0) {
            writer.uint32(10).bytes(message.token);
        }
...
exports.BlindOberonTokenResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.token.length !== 0) {
            writer.uint32(10).bytes(message.token);
        }
...
exports.UnBlindOberonTokenRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.token.length !== 0) {
            writer.uint32(10).bytes(message.token);
        }
...
exports.UnBlindOberonTokenResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.token.length !== 0) {
            writer.uint32(10).bytes(message.token);
        }
...
exports.VerifyOberonTokenRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.token.length !== 0) {
            writer.uint32(10).bytes(message.token);
        }
...
exports.VerifyOberonTokenResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.valid === true) {
            writer.uint32(8).bool(message.valid);
        }
