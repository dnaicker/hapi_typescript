...
exports.EncryptionRecipient = exports.EncryptionHeader = exports.EncryptedMessage = exports.SignatureHeader = exports.Signature = exports.SignedMessage = exports.encryptionAlgorithmToJSON = exports.encryptionAlgorithmFromJSON = exports.EncryptionAlgorithm = exports.encryptionModeToJSON = exports.encryptionModeFromJSON = exports.EncryptionMode = void 0;
/* eslint-disable */
...
function encryptionModeFromJSON(object) {
    switch (object) {
        case 0:
...
exports.encryptionModeFromJSON = encryptionModeFromJSON;
function encryptionModeToJSON(object) {
    switch (object) {
...
exports.encryptionModeToJSON = encryptionModeToJSON;
...
function encryptionAlgorithmFromJSON(object) {
    switch (object) {
        case 0:
...
exports.encryptionAlgorithmFromJSON = encryptionAlgorithmFromJSON;
function encryptionAlgorithmToJSON(object) {
    switch (object) {
...
exports.encryptionAlgorithmToJSON = encryptionAlgorithmToJSON;
...
exports.SignedMessage = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.signatures) {
            exports.Signature.encode(v, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromPartial(object) {
        ...
        message.signatures =
            ((_b = object.signatures) === null || _b === void 0 ? void 0 : _b.map((e) => exports.Signature.fromPartial(e))) || [];
        return message;
    },
};
...
exports.EncryptedMessage = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.recipients) {
            exports.EncryptionRecipient.encode(v, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.recipients.push(exports.EncryptionRecipient.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            ...
            recipients: Array.isArray(object === null || object === void 0 ? void 0 : object.recipients)
                ? object.recipients.map((e) => exports.EncryptionRecipient.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.recipients) {
            obj.recipients = message.recipients.map((e) => e ? exports.EncryptionRecipient.toJSON(e) : undefined);
        }
        else {
            obj.recipients = [];
        }
    ...
    fromPartial(object) {
        ...
        message.recipients =
            ((_e = object.recipients) === null || _e === void 0 ? void 0 : _e.map((e) => exports.EncryptionRecipient.fromPartial(e))) || [];
        return message;
    },
};
...
exports.EncryptionRecipient = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.header !== undefined) {
            exports.EncryptionHeader.encode(message.header, writer.uint32(10).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.header = exports.EncryptionHeader.decode(reader, reader.uint32());
                    break;
                case 2:
    ...
    fromJSON(object) {
        return {
            header: isSet(object.unprotected)
                ? exports.EncryptionHeader.fromJSON(object.unprotected)
                : undefined,
    ...
    toJSON(message) {
        ...
        message.header !== undefined &&
            (obj.unprotected = message.header
                ? exports.EncryptionHeader.toJSON(message.header)
                : undefined);
    ...
    fromPartial(object) {
        ...
        message.header =
            object.header !== undefined && object.header !== null
                ? exports.EncryptionHeader.fromPartial(object.header)
                : undefined;
        message.contentEncryptionKey =
