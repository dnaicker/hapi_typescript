...
})(DocumentKeyFormat || (DocumentKeyFormat = {}));
export function documentKeyFormatFromJSON(object) {
    switch (object) {
        case 0:
...
export function documentKeyFormatToJSON(object) {
    switch (object) {
...
export const GenerateKeyResponse = {
    ...
    fromJSON(object) {
        return {
            key: Array.isArray(object === null || object === void 0 ? void 0 : object.key)
                ? object.key.map((e) => JsonWebKey.fromJSON(e))
                : [],
    ...
    fromPartial(object) {
        var _a, _b;
        const message = createBaseGenerateKeyResponse();
        message.key = ((_a = object.key) === null || _a === void 0 ? void 0 : _a.map((e) => JsonWebKey.fromPartial(e))) || [];
...
export const ResolveResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            keys: Array.isArray(object === null || object === void 0 ? void 0 : object.keys)
                ? object.keys.map((e) => JsonWebKey.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        ...
        message.keys = ((_b = object.keys) === null || _b === void 0 ? void 0 : _b.map((e) => JsonWebKey.fromPartial(e))) || [];
        return message;
    },
};
